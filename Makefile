NAME=cub3D
CC=gcc
CFLAGS=-Wall -Wextra -Werror -g # -O3 -pg
SRCS=main.c parsing.c raycast.c init_cub3d.c init_data.c minimap.c init_data_utils.c utils.c utils_map.c utils_shift.c utils_raycast.c utils_bonus.c map.c
OBJS=$(SRCS:.c=.o)
